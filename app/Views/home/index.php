<section class="main-body">
    ...
    <div class="row bestsell-item">
        ...
        <div class="col-lg-6 col-12" id="banner-bestsell2">
            <div class="row">
                <div class="col-4">
                    <div id="bestsell-mini-right"><img src="/logo/case1.jpg" class="img-fluid"></div>
                    <div id="name-item-mini-right">Fancy - From Crazy World</div>
                    <div id="classify-item-mini-right">Personalized Shirt</div>
                    <div id="price-item-mini-right">$34.99 USD</div>
                    <div id="ellipse-item"><span>NEW</span></div>
...
<section class="cover-img">
    <div class="row">
        <div class="col-12 ">
            <img src="/logo/cover-image.jpg" class="img-fluid">
        </div>
    </div>
</section>
<section class="category">
...
<section class="cover-img">
    <div class="row">
        <div class="col-6">
            <img src="/logo/cover-image2.jpg" class="img-fluid">
        </div>
        <div class="col-6">
            <img src="/logo/cover-image3.GIF" class="img-fluid">
        </div>
    </div>
</section>
