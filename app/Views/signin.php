...
<head>
    ...
    <link href="/assets/css/pages/login/classic/login-4.css?v=7.1.5" rel="stylesheet"
          type="text/css"/>
    <!--end::Page Custom Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="/assets/plugins/global/plugins.bundle.css?v=7.1.5" rel="stylesheet"
          type="text/css"/>
    <link href="/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.1.5"
          rel="stylesheet" type="text/css"/>
    <link href="/assets/css/style.bundle.css?v=7.1.5" rel="stylesheet" type="text/css"/>
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="/assets/css/themes/layout/header/base/dark.css?v=7.1.5" rel="stylesheet"
          type="text/css"/>
    <link href="/assets/css/themes/layout/header/menu/light.css?v=7.1.5" rel="stylesheet"
          type="text/css"/>
    <link href="/assets/css/themes/layout/brand/dark.css?v=7.1.5" rel="stylesheet"
          type="text/css"/>
    <link href="/assets/css/themes/layout/aside/dark.css?v=7.1.5" rel="stylesheet"
          type="text/css"/>
    <!--end::Layout Themes-->
        ...
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
            ...
            <div class="login-form text-center p-7 position-relative overflow-hidden">
                ...
                <div class="d-flex flex-center mb-15">
                    <a href="#">
                        <img src="/assets/media/logos/logo-letter-13.png"
                    ...
                    <form class="form" id="kt_login_signin_form" action="">
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text"
                                   placeholder="Email or Username" name="username" autocomplete="off"/>
                        </div>
                        <div class="form-group mb-5">
                ...
                <div class="login-signup">
                    ...
                    <form class="form" id="kt_login_signup_form" action="">
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text"
                        ...
                        <div class="form-group d-flex flex-wrap flex-center mt-10">
                            <button id="kt_login_signup_submit" type="button"
                                    class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-2">Sign
                                Up
                            </button>
                            <button id="kt_login_signup_cancel" type="button"
                ...
                <div class="login-forgot">
                    ...
                    <form class="form" id="kt_login_forgot_form" action="">
                        ...
                        <div class="form-group d-flex flex-wrap flex-center mt-10">
                            <button id="kt_login_forgot_submit" type="button"
...
<script src="/assets/js/pages/custom/login/login-general.js?v=7.1.5"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
