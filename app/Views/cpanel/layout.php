        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1"
                     data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 271px; overflow: hidden;">
                    <!--begin::Menu Nav-->
                    <ul class="menu-nav">
                    ...
                    <div class="ps__rail-y" style="top: 0px; height: 271px; right: 4px;">
                        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 63px;"></div>
                    </div>
                </div>
                <!--end::Menu Container-->
            </div>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <!--end::Header-->
    <!--begin::Content-->
    <div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 256px; overflow: hidden;">
        <!--begin::Header-->
        ...
        <div class="ps__rail-y" style="top: 0px; height: 256px; right: 0px;">
            <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 74px;"></div>
        </div>
    </div>
    <!--end::Content-->
</div>
...
<div id="kt_quick_cart" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content">
        <!--begin::Wrapper-->
        <div class="offcanvas-wrapper mb-5 scroll-pull scroll ps ps--active-y" style="height: 122px; overflow: hidden;">
            <!--begin::Item-->
            ...
            <div class="ps__rail-y" style="top: 0px; height: 122px; right: -2px;">
...
<div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
    ...
    <div class="offcanvas-content px-10">
        <div class="tab-content">
            <!--begin::Tabpane-->
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active scroll ps ps--active-y" id="kt_quick_panel_logs"
                 role="tabpanel" style="height: 251px; overflow: hidden;">
                <!--begin::Section-->
                <div class="mb-15">
                ...
                <div class="ps__rail-y" style="top: 0px; height: 251px; right: 0px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 76px;"></div>
                </div>
            </div>
            <!--end::Tabpane-->
            <!--begin::Tabpane-->
            <div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="kt_quick_panel_notifications" role="tabpanel"
                 style="height: 251px; overflow: hidden;">
                <!--begin::Nav-->
            ...
            <!--end::Tabpane-->
            <!--begin::Tabpane-->
            <div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="kt_quick_panel_settings" role="tabpanel"
                 style="height: 251px; overflow: hidden;">
                <form class="form">
                    <!--begin::Section-->
                    <div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <!--begin::Scroll-->
                    <div class="scroll scroll-pull ps" data-height="375" data-mobile-height="300"
...
<svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1"
    ...
    <path id="SvgjsPath1004"
          d="M-1 200L-1 200C-1 200 64.16666666666667 200 64.16666666666667 200C64.16666666666667 200 128.33333333333334 200 128.33333333333334 200C128.33333333333334 200 192.5 200 192.5 200C192.5 200 256.6666666666667 200 256.6666666666667 200C256.6666666666667 200 320.8333333333333 200 320.8333333333333 200C320.8333333333333 200 385 200 385 200C385 200 385 200 385 200 "></path>
</svg>
<div class="daterangepicker ltr show-ranges opensleft">
    ...
    <div class="drp-buttons"><span class="drp-selected"></span>
        <button class="cancelBtn btn btn-sm btn-light-primary" type="button">Cancel</button>
...
<script>
    $('#btnUpdateEmail').on('click', function (e) {
        e.preventDefault();
