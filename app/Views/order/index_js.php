            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, val) {
                        ...
                        total += price;
                        $element.append('<div class="col-md-12 order-list"><div class="order-div"><div class="row"><div class="col-12 text-right"><div class="div-un-cart"><i class="far fa-times uncart" data-id="' + i + '" ></i></div></div></div><div class="order-img d-flex"><div class="order-img-front"><img src="' + val.front + '" class="w-100"><div class="icon-front centerContent">Front</div></div><div class="order-img-back "><img src="' + val.back + '" class="w-100"><div class="icon-back centerContent">Back</div></div></div><div class="row" style="margin-top: 25px"><div class="col-8"><div class="order-item-name"><span>' + val.name + '</span><br><div class="order-item-type">Product type:<span>Two Tone Mug Blue 11 oz</span></div></div></div><div class="col-4"><div class="quantity"><span>Quantity:</span> <input type="number" class="inputQuantity" value="' + val.quantity + '" data-loca="' + i + '"></div></div><div class="col-8"><div class="order-item-price">' + $priceEL + '</div></div><div class="col-4"><div class="delivery"><img src="/logo/truck-logo.png" style="height: 30px;width: 30px"><span>Delivery</span><br><span class="text-expree">' + val.delivery + '</span></div></div></div></div></div>');
